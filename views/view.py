...
def user_area():
    ...
    #info dos bilhetes 2
    Label(root, text="Nome do Espetáculo:", font=("Arial", 9), justify="right").grid(row=9, column=0, sticky=W)
    Label(root, text="Data do Espetáculo:", font=("Arial", 9), justify="right").grid(row=10, column=0, sticky=W)
    Label(root, text="Tipo de bilhete:", font=("Arial", 9), justify="right").grid(row=11, column=0, sticky=W)
    Label(root, text="Lugar:", font=("Arial", 9), justify="right").grid(row=12, column=0, sticky=W)
    Label(root, text="Preço do Bilhete:", font=("Arial", 9), justify="right").grid(row=13, column=0, sticky=W)
    #imagem perfil VER COMO FZR
    #ImageTk(root, file="perfil.ppm").grid(row=0, column= 10, sticky=E)
    #nome do user
    Label(root, text="User:", font=("Arial", 9), justify="right").grid(row=6, column=30, sticky=NE)
    #botao logout
    Button(root,text="Log Out",width=10,height=2, justify="right").grid(column=20,row=7, sticky=NE)
    root.mainloop()
